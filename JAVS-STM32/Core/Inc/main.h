...
#define LED_3_R_Pin GPIO_PIN_3
#define LED_3_R_GPIO_Port GPIOA
#define LED_3_G_Pin GPIO_PIN_0
#define LED_3_G_GPIO_Port GPIOB
#define LED_3_B_Pin GPIO_PIN_1
...
#define LED_2_R_Pin GPIO_PIN_4
#define LED_2_R_GPIO_Port GPIOB
#define LED_2_G_Pin GPIO_PIN_5
#define LED_2_G_GPIO_Port GPIOB
#define LED_2_B_Pin GPIO_PIN_6
